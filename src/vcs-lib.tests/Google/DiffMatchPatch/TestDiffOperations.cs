...
namespace nicTest
{
    public class TestDiffOperations : DiffOperations
    {
        ...
        public void diff_commonPrefixTest() {
            ...
            // Null case.
            Assert.AreEqual(0, dmp.FindCommonPrefix("abc", "xyz"));

            // Non-null case.
            Assert.AreEqual(4, dmp.FindCommonPrefix("1234abcdef", "1234xyz"));

            // Whole case.
            Assert.AreEqual(4, dmp.FindCommonPrefix("1234", "1234xyz"));
        }
